...
window.DATA_CENTERS = [
  ...
  // --- Verification-pass additions — DC presence at previously gap-flagged endpoints ---

  { project: "Stargate Lordstown AI campus (OpenAI / Oracle / SoftBank)",
    operator: "Stargate LLC", status: "under_construction",
    lat: 41.1614, lng: -80.8651,
    in_service: "2026 (operational target per OpenAI announcement)",
    in_service_source: "OpenAI — 'SoftBank has broken ground ... on track to be operational next year' (https://openai.com/index/five-new-stargate-sites/)",
    power_mw: 1500,
    power_mw_source: "OpenAI — 'Lordstown site, together with Milam County TX, scale to 1.5 GW over the next 18 months'; WFMJ — 'Lordstown part of mammoth $500B AI data center project'" },

  { project: "Meta Bowling Green / Middleton Township data center (verified location)",
    operator: "Meta Platforms", status: "under_construction",
    lat: 41.4145, lng: -83.6238,
    in_service: "under construction (ground broken)",
    in_service_source: "Data Center Dynamics — 'Ground has been broken on the site, off State Rt. 582 between SR-25 and I-75'",
    power_mw: 715,
    power_mw_source: "DCD — '715,000-square-foot project' (sq ft → IT load est. via Meta's ~1 MW per 1,000 sf hyperscale ratio)" },

  { project: "ark data centers Independence (formerly Involta)",
    operator: "ark data centers", status: "operational",
    lat: 41.3839, lng: -81.6376,
    in_service: "operational",
    in_service_source: "datacentermap.com — 'Ark Data Centers Independence in Cleveland'",
    power_mw: 2.5,
    power_mw_source: "datacentermap.com — '2.5 MW'" },

  { project: "ark data centers Akron I + II",
    operator: "ark data centers (formerly Involta)", status: "operational",
    lat: 41.0428, lng: -81.5071,
    in_service: "operational; 2025 expansion announced",
    in_service_source: "Signal Akron — '$4.5M tax credit will help data center expand in Akron'; datacenterhawk — '191 E. Miller Ave Akron I + II'",
    power_mw: 1,
    power_mw_source: "datacentermap.com — '1 MW'" },

  { project: "Summit County remaining ark / colocation cluster (5 in-Akron sites)",
    operator: "Various", status: "operational",
    lat: 41.0814, lng: -81.519,
    in_service: "operational",
    in_service_source: "Signal Akron — 'Summit County currently has seven data centers within its borders. Five of those seven are in Akron'",
    power_mw: null,
    power_mw_source: "Not published — site-level MW not disclosed for the remaining facilities" },

  { project: "Fairlawn data-center site (rezoning)",
    operator: "Undisclosed", status: "proposed",
    lat: 41.1339, lng: -81.6262,
    in_service: "proposed (rezoning approved)",
    in_service_source: "Akron.com — 'Fairlawn rezones land for data center'",
    power_mw: null,
    power_mw_source: "Not published" },

  { project: "Slavic Village hyperscale data center (E. 55th St)",
    operator: "Lakeland Equity Group (Westlake, OH)", status: "cancelled (permit denied May 2026)",
    lat: 41.4543, lng: -81.6515,
    in_service: "announced 2026, permit denied May 2026",
    in_service_source: "NEOtrans — '$1.6B data center planned in Cleveland'; Cleveland 19 — 'neighbors raise concerns about proposed Cleveland data center'",
    power_mw: 150,
    power_mw_source: "NEOtrans — '150 MW per day—enough to supply about 100,000 homes' (project cancelled; capacity figure preserved as evidence of disclosed activity)" },

  { project: "CyrusOne Mason",
    operator: "CyrusOne", status: "operational",
    lat: 39.3601, lng: -84.3088,
    in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'CyrusOne Mason data center at 4800 Parkway Drive Mason, OH 45040'",
    power_mw: null,
    power_mw_source: "Not published — site-level MW not disclosed" },

  { project: "CyrusOne Blue Ash",
    operator: "CyrusOne", status: "operational",
    lat: 39.2515, lng: -84.3783,
    in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'CyrusOne Blue Ash at 4600 McAuley Place'",
    power_mw: null,
    power_mw_source: "Not published" },

  { project: "CyrusOne CIN4 Hamilton (Knightsbridge Drive)",
    operator: "CyrusOne", status: "operational",
    lat: 39.3995, lng: -84.5613,
    in_service: "operational",
    in_service_source: "Hamilton Journal-News — 'a 4.8-megawatt, 83,000-square-foot data center on Knightsbridge Drive, CyrusOne CIN4'",
    power_mw: 4.8,
    power_mw_source: "Journal-News — '4.8 MW, 83,000 sq ft'" },

  { project: "Flexential Cincinnati (West Chester)",
    operator: "Flexential", status: "operational",
    lat: 39.3392, lng: -84.4319,
    in_service: "operational",
    in_service_source: "Flexential — 'Cincinnati data center at 5307 Muhlhauser Road, West Chester, OH 45011'",
    power_mw: null,
    power_mw_source: "Not published" },

  { project: "Prologis / Duke Energy Trenton data-center site",
    operator: "Prologis", status: "announced",
    lat: 39.4828, lng: -84.4583,
    in_service: "announced October 2025",
    in_service_source: "Hamilton Journal-News — 'Prologis purchased the land from city of Trenton in October 2025; Duke Energy will be the energy supplier'",
    power_mw: null,
    power_mw_source: "Not published" },

  { project: "Waterville Township hyperscale (proposed)",
    operator: "Undisclosed", status: "proposed",
    lat: 41.5009, lng: -83.7186,
    in_service: "proposed",
    in_service_source: "Toledo Free Press — 'developer is eyeing 1,000 to 1,400 acres south of Neapolis-Waterville road for a hyperscale data center'",
    power_mw: null,
    power_mw_source: "Not published" },

  { project: "Lumen Toledo data center",
    operator: "Lumen", status: "operational",
    lat: 41.6528, lng: -83.5379,
    in_service: "operational",
    in_service_source: "Baxtel — 'Lumen: Toledo Data Center'",
    power_mw: null,
    power_mw_source: "Not published" },

...
window.DATA_CENTERS = [
  ...
  // ============== Verification Pass 2 — datacentermap.com Ohio enumeration ==============
  // datacentermap.com lists 24 Cleveland DCs alone; agent verified each against Baxtel /
  // datacenterhawk / operator sites. Major adds: Aligned NEO-01 (96 MW UC), Viking Akron
  // (150 MW), Google Lima (announced), Thor Equities Van Wert (500 MW announced), plus
  // dense Cleveland / Cincinnati / Columbus colo clusters.

  // --- Cleveland metro ---
  { project: "DataBank CLE1 (Downtown Cleveland)", operator: "DataBank", status: "operational",
    lat: 41.5012, lng: -81.6779, in_service: "operational",
    in_service_source: "datacentermap.com — 'DataBank CLE1 - Downtown Cleveland (0.4 MW)'",
    power_mw: 0.4, power_mw_source: "datacentermap.com — '0.4 MW'" },
  { project: "H5 Cleveland Technology Center (CTC)", operator: "H5 Data Centers", status: "operational",
    lat: 41.5020, lng: -81.6862, in_service: "operational",
    in_service_source: "Baxtel — 'largest data center in Cleveland is H5 CTC with 4 MW and 64,000 SqFt'",
    power_mw: 4, power_mw_source: "Baxtel — '4 megawatts'" },
  { project: "Aligned NEO-01 (Cleveland campus)", operator: "Aligned Data Centers", status: "under_construction",
    lat: 41.4790, lng: -81.6630, in_service: "2026–2027",
    in_service_source: "DCD — 'Aligned breaks ground on Ohio data center campus'",
    power_mw: 96, power_mw_source: "datacenterhawk — 'NEO-01 will total 96 MW across 200,000 sq ft for the first building'" },
  { project: "Expedient Cleveland 151 (NEO Parkway)", operator: "Expedient", status: "operational",
    lat: 41.4170, lng: -81.5990, in_service: "operational",
    in_service_source: "datacenterhawk — 'Expedient Cleveland 151 | 15166 Neo Parkway'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Expedient Cleveland 152 (NEO Parkway)", operator: "Expedient", status: "operational",
    lat: 41.4172, lng: -81.5985, in_service: "operational",
    in_service_source: "datacenterhawk — 'Expedient Cleveland 152 | 15248 Neo Parkway'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "BlueBridge Networks Cleveland (Sterling Building, Playhouse Square)", operator: "BlueBridge Networks", status: "operational",
    lat: 41.5012, lng: -81.6800, in_service: "operational",
    in_service_source: "datacentermap.com — 'BlueBridge Networks Data Center in Cleveland'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "StratCap 4100 W 150 (Cleveland)", operator: "StratCap Data Centers", status: "operational",
    lat: 41.4456, lng: -81.7600, in_service: "acquired 2024",
    in_service_source: "Baxtel — 'StratCap acquired Cleveland DC, 187,000 sq ft'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Cogent Cleveland 1 (1621 Euclid)", operator: "Cogent Communications", status: "operational",
    lat: 41.5025, lng: -81.6790, in_service: "operational",
    in_service_source: "datacentermap.com — 'Cogent Cleveland | 1621 Euclid Ave (0.2 MW)'",
    power_mw: 0.2, power_mw_source: "datacentermap.com — '0.2 MW'" },
  { project: "Cogent Cleveland 2 (2650 Rockefeller)", operator: "Cogent Communications", status: "operational",
    lat: 41.5165, lng: -81.6315, in_service: "operational",
    in_service_source: "Brightlio — 'Cogent Cleveland 2 at 2650 Rockefeller Ave 44115, 5,804 sq ft'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Verizon Cleveland (1525 Rockwell)", operator: "Verizon", status: "operational",
    lat: 41.5021, lng: -81.6883, in_service: "operational",
    in_service_source: "Baxtel — 'Verizon: 1525 Rockwell'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Lumen Cleveland (4000 Chester)", operator: "Lumen Technologies", status: "operational",
    lat: 41.5050, lng: -81.6618, in_service: "operational",
    in_service_source: "Baxtel — 'Lumen Cleveland (4000 Chester)'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Lumen Cleveland 4", operator: "Lumen Technologies", status: "operational",
    lat: 41.5012, lng: -81.6790, in_service: "operational",
    in_service_source: "Baxtel — 'Lumen Cleveland 4'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Lumen Cleveland 5", operator: "Lumen Technologies", status: "operational",
    lat: 41.5012, lng: -81.6790, in_service: "operational",
    in_service_source: "Baxtel — 'Lumen Cleveland 5'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "SecureData 365 Cleveland", operator: "SecureData 365", status: "operational",
    lat: 41.5050, lng: -81.6800, in_service: "operational",
    in_service_source: "Baxtel — 'SecureData 365 Cleveland'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Fusion Connect Cleveland", operator: "Fusion Connect", status: "operational",
    lat: 41.5012, lng: -81.6790, in_service: "operational",
    in_service_source: "Baxtel — 'Fusion Connect Cleveland'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Cleveland Clinic Brecksville data center", operator: "Cleveland Clinic", status: "operational",
    lat: 41.3179, lng: -81.6262, in_service: "operational",
    in_service_source: "Baxtel — 'Cleveland Clinic Brecksville Data Center'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Green Bridge 12875 Corporate (Cleveland)", operator: "Green Bridge Real Estate", status: "operational",
    lat: 41.4520, lng: -81.5800, in_service: "operational",
    in_service_source: "datacentermap.com — '12875 Corporate, Cleveland'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "LightSpeed Hosting (Medina/Akron corridor)", operator: "LightSpeed Hosting", status: "operational",
    lat: 41.1384, lng: -81.8635, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'Route 18 corridor between Medina and Akron'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "H5 Parma data center", operator: "H5 Data Centers", status: "operational",
    lat: 41.4047, lng: -81.7229, in_service: "operational",
    in_service_source: "H5 site — 'Parma, OH, 16 miles south of downtown Cleveland; 351,000 SF'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Akron / Canton ---
  { project: "Viking Akron (428 Seiberling)", operator: "Viking Data Centers", status: "operational",
    lat: 41.0888, lng: -81.4757, in_service: "2021 (scaled to 150 MW by 2024)",
    in_service_source: "Signal Akron — 'opened 2021, scaled from 20 MW to 150 MW by 2024'",
    power_mw: 150, power_mw_source: "PRNewswire — 'Atlantic Energy to power 380,000 sq ft Akron facility expandable to 150 MW'" },
  { project: "Lumen Akron 2", operator: "Lumen Technologies", status: "operational",
    lat: 41.0814, lng: -81.5190, in_service: "operational",
    in_service_source: "Baxtel — 'Lumen Akron 2'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Cogent Akron", operator: "Cogent Communications", status: "operational",
    lat: 41.0814, lng: -81.5190, in_service: "operational",
    in_service_source: "Signal Akron — 'Cogent Akron provides 50,747 sq ft of colocation'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Eyemg Akron data center", operator: "Eyemg", status: "operational",
    lat: 41.0814, lng: -81.5190, in_service: "operational",
    in_service_source: "Eyemg site — 'hosting and co-location in Akron Data Center'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "The Karcher Group (TKG) data center", operator: "The Karcher Group", status: "operational",
    lat: 40.8756, lng: -81.4023, in_service: "operational (20+ years)",
    in_service_source: "Signal Akron — 'TKG maintained its own data center for more than 20 years'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "ark Canton", operator: "ark data centers", status: "operational",
    lat: 40.7989, lng: -81.3784, in_service: "operational",
    in_service_source: "Baxtel — 'Ark: Canton'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Cincinnati metro ---
  { project: "H5 Cincinnati (360 Gest)", operator: "H5 Data Centers", status: "operational",
    lat: 39.1147, lng: -84.5301, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'H5 Cincinnati at 360 Gest Street'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Flexential Cincinnati (verified 3.8 MW)", operator: "Flexential", status: "operational",
    lat: 39.3414, lng: -84.4030, in_service: "operational",
    in_service_source: "Flexential — 'Cincinnati DC boasts 43,551 sq ft; 3.8 MW critical power'",
    power_mw: 3.8, power_mw_source: "Flexential — '3.8 MW of critical power'" },
  { project: "DartPoints CVG01 Cincinnati", operator: "DartPoints", status: "operational",
    lat: 39.1031, lng: -84.5170, in_service: "operational",
    in_service_source: "DartPoints — '14,715 sq ft; 1.6 MW utility power'",
    power_mw: 1.6, power_mw_source: "DartPoints — '1.6 MW utility power'" },
  { project: "DartPoints Cincinnati Eastgate", operator: "DartPoints", status: "operational",
    lat: 39.0945, lng: -84.2538, in_service: "operational",
    in_service_source: "ocolo.io — 'DartPoints Cincinnati Eastgate Data Center'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Encore Technologies NOR1 (Norwood)", operator: "Encore Technologies", status: "operational",
    lat: 39.1547, lng: -84.4602, in_service: "operational",
    in_service_source: "datacentermap.com — 'Encore NOR1 in Cincinnati'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Encore Technologies BLU1 (Blue Ash)", operator: "Encore Technologies", status: "operational",
    lat: 39.2438, lng: -84.3782, in_service: "operational",
    in_service_source: "datacentermap.com — 'Encore BLU1 at 11515 Grooms Rd, Blue Ash'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "CBTS Cincinnati 7th Street (1 Main St)", operator: "CBTS", status: "operational",
    lat: 39.1031, lng: -84.5085, in_service: "operational",
    in_service_source: "datacentermap.com — 'CBTS Cincinnati DC | 1 Main St'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "CBTS Gold Coast (Cincinnati)", operator: "CBTS", status: "operational",
    lat: 39.2630, lng: -84.3070, in_service: "operational",
    in_service_source: "datacentermap.com — 'CBTS Gold Coast | 55 Miners Way'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "CBTS Mason (784 S Forest)", operator: "CBTS", status: "operational",
    lat: 39.3601, lng: -84.3088, in_service: "operational",
    in_service_source: "datacenters.com — 'Mason DC at 784 S Forest Ave'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "CBTS Lebanon", operator: "CBTS", status: "operational",
    lat: 39.4395, lng: -84.2033, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'CBTS Lebanon Data Center'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Immedion Downtown Cincinnati", operator: "Immedion", status: "operational",
    lat: 39.1031, lng: -84.5120, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'Immedion Downtown Cincinnati'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Immedion Eastgate Cincinnati", operator: "Immedion", status: "operational",
    lat: 39.0945, lng: -84.2538, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'Immedion Eastgate Cincinnati'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "CyrusOne Lebanon (401 Fujitec)", operator: "CyrusOne", status: "operational",
    lat: 39.4395, lng: -84.2033, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'CyrusOne Lebanon at 401 Fujitec Dr'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Iron Mountain Cincinnati", operator: "Iron Mountain", status: "operational",
    lat: 39.1031, lng: -84.5120, in_service: "operational",
    in_service_source: "Iron Mountain — 'Cincinnati Data Center'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Columbus metro (additional Cologix + others) ---
  { project: "Cologix COL1 (Worthington)", operator: "Cologix", status: "operational",
    lat: 40.1009, lng: -83.0096, in_service: "operational",
    in_service_source: "Cologix — '4 current data centers (COL1-COL4); 535 Scherers Ct'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Cologix COL3 (Worthington)", operator: "Cologix", status: "operational",
    lat: 40.1015, lng: -83.0100, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'COL3 | 585 Scherers Ct'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Cologix COL4", operator: "Cologix", status: "operational",
    lat: 40.1015, lng: -83.0100, in_service: "operational",
    in_service_source: "Cologix — '4 current data centers (COL1-COL4)'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Cologix COL5 (AI-dedicated)", operator: "Cologix", status: "under_construction",
    lat: 40.1015, lng: -83.0100, in_service: "under construction",
    in_service_source: "Cologix — 'fifth AI-dedicated data center under construction'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Racksquared Spring Street", operator: "Racksquared", status: "operational",
    lat: 39.9700, lng: -82.9930, in_service: "~15 years (since 2010s)",
    in_service_source: "WOSU — 'Racksquared at 325 E. Spring St. for about 15 years'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "CeraNet DC1 (826 Morrison)", operator: "CeraNet", status: "operational",
    lat: 39.9817, lng: -82.8770, in_service: "operational",
    in_service_source: "datacentermap.com — 'CeraNet DC1 in Columbus'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Expedient Dublin (5700 Innovation)", operator: "Expedient", status: "operational",
    lat: 40.1090, lng: -83.1295, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'Expedient Dublin at 5700 Innovation Dr'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Lumen Columbus (180 E Broad)", operator: "Lumen (CenturyLink)", status: "operational",
    lat: 39.9626, lng: -82.9968, in_service: "operational",
    in_service_source: "Brightlio — 'CenturyLink at 180 E Broad St'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Csquare Lewis Center", operator: "Csquare", status: "operational",
    lat: 40.1992, lng: -82.9968, in_service: "operational",
    in_service_source: "csquare.com — 'Lewis Center data center 25 min from CMH'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "EdgeConneX New Albany Phase I (524,000 sq ft)", operator: "EdgeConneX", status: "under_construction",
    lat: 40.0809, lng: -82.8088, in_service: "April 2026 (expected)",
    in_service_source: "Data Center Frontier — 'Phase I 524,000 sq ft; completion April 2026'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Dayton ---
  { project: "Iron Mountain OHS-1 (Miamisburg)", operator: "Iron Mountain", status: "operational",
    lat: 39.6429, lng: -84.2866, in_service: "operational",
    in_service_source: "datacentermap.com — 'Iron Mountain OHS-1 (1.4 MW)'",
    power_mw: 1.4, power_mw_source: "datacentermap.com — '1.4 MW'" },
  { project: "DataYard Dayton (130 W 2nd)", operator: "DataYard", status: "operational",
    lat: 39.7589, lng: -84.1916, in_service: "operational (since 1995)",
    in_service_source: "datayard.us — 'family-owned cloud/IT provider operating since 1995'",
    power_mw: 0.5, power_mw_source: "datayard.us — '500 kW of filtered, conditioned A/B power'" },
  { project: "Lumen Dayton 2 (130 W 2nd)", operator: "Lumen Technologies", status: "operational",
    lat: 39.7589, lng: -84.1916, in_service: "operational",
    in_service_source: "datacentermap.com — 'Lumen Dayton 2 | 130 W 2nd St'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Lumen Dayton 3 (1 S Main, Fifth Third Center)", operator: "Lumen Technologies", status: "operational",
    lat: 39.7589, lng: -84.1916, in_service: "operational",
    in_service_source: "Baxtel — 'Lumen Dayton 3 at 1 S Main, former tw telecom in Fifth Third Center'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Toledo ---
  { project: "Telesystem DC-1 Toledo (4818 Angola)", operator: "Telesystem (Buckeye)", status: "operational",
    lat: 41.6312, lng: -83.6724, in_service: "operational",
    in_service_source: "datacentermap.com — 'Telesystem DC-1 in Toledo'",
    power_mw: 0.625, power_mw_source: "datacenters.com — '625 KVA fully redundant power'" },
  { project: "CISP Toledo (3035 Moffat)", operator: "Community ISP", status: "operational",
    lat: 41.6515, lng: -83.6975, in_service: "operational",
    in_service_source: "datacentermap.com — 'CISP DC in Toledo | 3035 Moffat'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Verizon Toledo", operator: "Verizon", status: "operational",
    lat: 41.6528, lng: -83.5379, in_service: "operational",
    in_service_source: "datacentermap.com — 'Toledo Data Centers — 3 Facilities'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Youngstown / Mahoning ---
  { project: "ark Youngstown (Involta legacy)", operator: "ark data centers", status: "operational",
    lat: 41.0998, lng: -80.6495, in_service: "operational",
    in_service_source: "Baxtel — 'Involta Youngstown 26,000+ sq ft purpose-built colo'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "DRS Youngstown North (1343 Belmont)", operator: "DRS Data Centers", status: "operational",
    lat: 41.1130, lng: -80.6650, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'DRS Youngstown (North)'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "DRS Youngstown South (3203 Southern)", operator: "DRS Data Centers", status: "operational",
    lat: 41.0635, lng: -80.6675, in_service: "operational",
    in_service_source: "cloudandcolocation.com — 'DRS Youngstown (South)'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "BTI Youngstown (East Commerce)", operator: "B-Telecom Inc.", status: "operational",
    lat: 41.0998, lng: -80.6495, in_service: "operational",
    in_service_source: "datacentermap.com — 'BTI Youngstown'",
    power_mw: null, power_mw_source: "Not published" },

  // --- Lima / Van Wert / smaller metros ---
  { project: "Google Project BOSC (Lima / American Township)", operator: "Google", status: "announced",
    lat: 40.7755, lng: -84.1300, in_service: "by 2030",
    in_service_source: "DCD — 'Construction expected 2026, completion by 2030; $500M Lima DC'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Thor Equities Van Wert campus (500 MW)", operator: "Thor Equities", status: "announced",
    lat: 40.8689, lng: -84.5836, in_service: "first 500 MW by 2028 (construction Q3/Q4 2026)",
    in_service_source: "thetechcapital — '500 MWs by 2028; physical construction Q3/Q4 2026'",
    power_mw: 500, power_mw_source: "DCD — '500 MW Ohio data center campus'" },
  { project: "Mansfield data center (operator unverified)", operator: "Unknown", status: "operational",
    lat: 40.7584, lng: -82.5154, in_service: "operational",
    in_service_source: "datacentermap.com — 'Mansfield Data Centers — 1 Facility'",
    power_mw: null, power_mw_source: "Not published" },
  { project: "Urbana data center (proposed CRA)", operator: "Undisclosed", status: "proposed",
    lat: 40.1083, lng: -83.7524, in_service: "TBD",
    in_service_source: "Urbana Citizen — 'Data center interest confirmed; Urbana officials address concerns'",
    power_mw: null, power_mw_source: "Not published" },
